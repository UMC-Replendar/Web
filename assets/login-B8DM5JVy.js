...
`,i=o.div`
  ...
  animation: ${w} ${({duration:t})=>t} linear infinite;
  animation-delay: ${({delay:t})=>t};
`;function Q(){const t=()=>{console.log("카카오 로그인 버튼 클릭됨!");const a="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=2a8cd1a16e800418871f38ff1c542ed1&redirect_uri=https://www.replendar.site/callback";window.location.href=a};return e.jsxs(g,{children:[e.jsx(x,{children:e.jsx(h,{src:s,alt:"앱 아이콘"})}),e.jsx(f,{children:"REPLENDAR"}),e.jsxs(p,{onClick:t,children:[e.jsx("img",{src:l,alt:"Kakao Logo"}),"카카오로 로그인하기"]}),e.jsx(r,{src:d,alt:"Character 1",top:"85%",left:"25%"}),e.jsx(r,{src:c,alt:"Character 2",top:"85%",left:"70%"}),e.jsx(r,{src:n,alt:"Character 3",top:"70%",left:"80%"}),e.jsx(i,{top:"5%",size:"40px",duration:"15s",delay:"0s"}),e.jsx(i,{top:"15%",size:"50px",duration:"10s",delay:"1s"}),e.jsx(i,{top:"20%",size:"50px",duration:"20s",delay:"2s"}),e.jsx(i,{top:"40%",size:"35px",duration:"18s",delay:"3s"}),e.jsx(i,{top:"70%",size:"45px",duration:"12s",delay:"2s"}),e.jsx(i,{top:"60%",size:"45px",duration:"22s",delay:"1s"}),e.jsx(i,{top:"80%",size:"30px",duration:"17s",delay:"4s"})]})}export{Q as default};
