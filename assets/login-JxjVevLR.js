...
`,u=i.span``,o=i.div`
  ...
  animation: ${B} ${({duration:t})=>t} linear infinite;
  animation-delay: ${({delay:t})=>t};
`;function k(){const t=()=>{console.log("카카오 로그인 버튼 클릭됨!");const a="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=2a8cd1a16e800418871f38ff1c542ed1&redirect_uri=https://www.replendar.site/callback";window.location.href=a};return e.jsxs(f,{children:[e.jsx(w,{children:e.jsx(x,{src:n,alt:"앱 아이콘"})}),e.jsx(p,{children:"REPLENDAR"}),e.jsxs(h,{onClick:t,children:[e.jsx("img",{src:s,alt:"Kakao Logo"}),"카카오로 로그인하기"]}),e.jsx(A,{to:"/fakelogin",children:e.jsx(u,{children:"테스트 로그인"})}),e.jsx(r,{src:g,alt:"Character 1",top:"85%",left:"25%"}),e.jsx(r,{src:d,alt:"Character 2",top:"85%",left:"70%"}),e.jsx(r,{src:c,alt:"Character 3",top:"70%",left:"80%"}),e.jsx(o,{top:"5%",size:"40px",duration:"15s",delay:"0s"}),e.jsx(o,{top:"15%",size:"50px",duration:"10s",delay:"1s"}),e.jsx(o,{top:"20%",size:"50px",duration:"20s",delay:"2s"}),e.jsx(o,{top:"40%",size:"35px",duration:"18s",delay:"3s"}),e.jsx(o,{top:"70%",size:"45px",duration:"12s",delay:"2s"}),e.jsx(o,{top:"60%",size:"45px",duration:"22s",delay:"1s"}),e.jsx(o,{top:"80%",size:"30px",duration:"17s",delay:"4s"})]})}export{k as default};
